...
public class Facebook_Signup {
	...
	public void signup() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver1.findElement(By.name("firstname")).sendKeys("Arjun");
		Thread.sleep(2000);
		driver1.findElement(By.name("lastname")).sendKeys("Jaiswal");
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_email__")).sendKeys("arjunjaiswal8065@gmail.com");
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_email_confirmation__")).sendKeys("arjunjaiswal8065@gmail.com");
		Thread.sleep(2000);
		driver1.findElement(By.name("reg_passwd__")).sendKeys("Aarati@12");
		Thread.sleep(2000);
		...
		d_Dropdown.selectByVisibleText("1");
