...
public class HandelingWindow_ {
	...
	public void handleTabs_using_getWindowHandles() {
		...
		//enter username
		driver.findElement(By.xpath("//input[@id='txtUsername']")).sendKeys("Arjun");
		//enter password
		driver.findElement(By.xpath("//input[@id='txtPassword']")).sendKeys("aarati");
