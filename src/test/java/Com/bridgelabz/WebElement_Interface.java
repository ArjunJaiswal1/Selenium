...
public class WebElement_Interface {
	...
	public void RemoveElementFromTextBox() throws InterruptedException {
		...
		driver.manage().window().maximize();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("arjun12@gmail.com");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("againEnteredarjun");
		Thread.sleep(2000);
	...
	public void DeleteWothoutUsingClear() throws InterruptedException {
		...
		driver.manage().window().maximize();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("sunny");
		Thread.sleep(2000);
		String value = driver.findElement(By.xpath("//input[@type='text']")).getAttribute("value");
		System.out.println("Value present inside the text box is : "+value);
		driver.findElement(By.xpath("//input[@type='text']")).clear();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("againEnteredsunny");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys(Keys.CONTROL+"a"+Keys.DELETE);
		Thread.sleep(2000);
	}
	...
	public void getAttribute() throws InterruptedException{
		...
		driver.manage().window().maximize();
		Thread.sleep(2000);
		String elementType = driver.findElement(By.xpath("//input[@type='text']")).getAttribute("arjun12@gmail.com");
